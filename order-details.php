				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail">
						    <img src="admin/productimages/<?php echo $row['opid'];?>/<?php echo $row['pimg1'];?>" alt="" width="114" height="146">
						</a>
					</td>
					...
					<td class="cart-product-sub-total"><?php echo $price=$row['pprice']+$row['shipc'];; ?>  </td>
